...
const Footer: React.FC = (): JSX.Element => {
  return (
    <footer className=" bg-primary dark:bg-primaryDark p-4  md:flex md:items-center md:justify-between md:p-6 ">
      <span className="text-sm text-gray-500 sm:text-center dark:text-primaryLight">
        © 2022
        <a
